      ...
      let u = (0, i.forwardRef)((e, t) => {
          ...
          return (0, n.jsxs)("div", {
            ...
            children: [
              (0, n.jsx)("div", {
                ref: s,
                className:
                  "w-[80%] mx-auto opacity-0 invisible h-[45%] mt-[3rem] flex items-center justify-center text-44 leading-[86%] text-light_beige text-center font-headings -tracking-[0.176rem]",
                children: r,
              }),
              (0, n.jsx)("div", {
                ref: o,
        ...
        d = (0, i.forwardRef)((e, t) => {
          ...
          return (
            ...
            (0, n.jsx)("div", {
              ref: c,
              className: "flex-1 flex justify-between text-14 text-light_beige",
              children: (0, n.jsx)("div", {
      ...
      let x = (0, i.forwardRef)((e, t) => {
          ...
          return (0, n.jsx)("div", {
            ...
            children:
              ...
              (0, n.jsx)("div", {
                className:
                  "block w-full text-center bg-white xl:bg-light_beige landscape:bg-light_beige xl:transition-bg xl:duration-global xl:ease-out xl:hover:bg-dark_beige/50 text-light_beige text-10 tracking-[0.05rem] leading-[180%] md:text-12 md:tracking-[0.036rem] md:leading-[200%] font-body-mono uppercase",
        ...
        w = (e) => {
          ...
          return (0, n.jsxs)("div", {
            ...
            children: [
              (0, n.jsxs)("div", {
                className:
                  "w-[36.5%] h-[calc(100vh_-_2rem)] sticky top-10 bg-white  flex flex-col pb-[3rem] px-[3rem]",
                children: [
                  (0, n.jsx)("div", {
                    className:
              ...
              (0, n.jsx)("div", {
                className:
                  "flex-1 h-[calc(100vh_-_2rem)] sticky top-10  overflow-hidden z-1",
                children: t.items.map((e, t) =>
                  (0, n.jsx)(
                    "div",
                    {
                      ref: (e) => (c.current[t] = e),
                      className:
                        "w-full h-full absolute left-0 top-0 overflow-hidden",
                      style: { zIndex: t + 1 },
                  ...
                  "div",
                  {
                    ...
                    className:
                      "relative landscape:sticky landscape:top-0 landscape:".concat(
                        r,
                        " p-half-container-mobile md:p-half-container w-full h-[calc(100vh_-_1.2rem)] md:h-[calc(100vh_-_2rem)] flex flex-col mb-[1.2rem] landscape:mb-10 bg-white landscape:flex-row landscape:gap-x-[0.4rem] landscape:h-screen",
                      ),
                    style: { zIndex: l + 1 },
                    children: [
                      (0, n.jsx)("div", {
                      ...
                      (0, n.jsxs)("div", {
                        ...
                        children: [
                          (0, n.jsx)("div", {
                            className:
                              "text-32 text-light_beige text-center font-headings -tracking-[0.128rem] leading-[93%] landscape:pb-[14.4rem] landscape:text-44 landscape:leading-[86%] landscape:-tracking-[0.176rem]",
                          ...
                          (0, n.jsx)("div", {
                            className:
                              "px-[4.55rem] text-13 tracking-[0.013rem] leading-[153.8%] text-light_beige text-center md:w-[60%] md:landscape:w-[80%]",
