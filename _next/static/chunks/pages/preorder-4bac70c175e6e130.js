            ...
            (0, r.jsxs)("div", {
              ...
              children: [
                "phone" === o.type &&
                  (0, r.jsxs)("div", {
                    className:
                      "c-input-select relative flex items-center text-14 leading-[2rem] tracking-[0.014rem] pb-[1.6rem] text-light_beige bg-transparent border-[0] border-b-dark_grey/[0.15] border-b-[1px] border-solid mr-[1rem]",
                    children: [
                      (0, r.jsx)("div", {
                        ref: i,
                        className: "mr-[0.7rem]",
                      ...
                      (0, r.jsxs)("select", {
                        ...
                        id: "",
                        className:
                          "absolute top-0 left-0 w-full h-full border-[0] bg-transparent opacity-0",
                        children: [
                          (0, r.jsx)("option", {
                ...
                (0, r.jsxs)("div", {
                  ...
                  children: [
                    (0, r.jsx)("label", {
                      htmlFor: o.name,
                      className:
                        "absolute w-full text-14 leading-[2rem] tracking-[0.014rem] text-light_beige origin-top-left pointer-events-none transition-transform duration-global ease-out group-[.is-focus]:-translate-y-[1.8rem] group-[.is-focus]:scale-[0.8]",
                      children: n || o.placeholder,
                    }),
                    (0, r.jsx)("input", {
                      className:
                        "c-input w-full text-14 leading-[2rem] tracking-[0.014rem] text-light_beige bg-transparent pb-[1.6rem] border-b-dark_grey/[0.15] border-b-[1px] border-solid outline-none group-[.is-focus]:placeholder:opacity-100 ".concat(
      ...
      let Z = (0, l.forwardRef)((e, t) => {
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [
            ...
            (0, r.jsx)("div", {
              className:
                "text-20 text-light_beige leading-[118%] -tracking-[0.02rem] font-headings",
            ...
            children: [
              ...
              (0, r.jsxs)("div", {
                ...
                children: [
                  (0, r.jsxs)("div", {
                    className:
                      "relative flex-1 bg-white  overflow-hidden hidden xl:block",
                    children: [
                      (0, r.jsx)(_.Z, {
                        field: t.data.image,
                        fallbackAlt: "",
                  ...
                  (0, r.jsxs)("form", {
                    ...
                    className:
                      "relative w-full xl:w-[36.5%] min-h-[calc(100vh_-_2rem)] h-full  bg-white flex flex-col items-center",
                    children: [
                      (0, r.jsx)("div", {
                        className:
                      ...
                      (0, r.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, r.jsx)("h1", {
                            className:
                              "font-headings text-36 leading-[3.4rem] -tracking-[0.144rem] md:text-[3.4rem] md:leading-[3.3rem] md:-tracking-[0.138rem] text-light_beige font-medium mt-[1.23rem]",
                          ...
                          (0, r.jsxs)(g, {
                            ...
                            children: [
                              ...
                              (0, r.jsxs)("label", {
                                ...
                                htmlFor: "pebble-flow",
                                className:
                                  "relative block bg-light_beige/50 xl:bg-light_beige/30 px-[2.5rem] md:px-30 pt-[3.9rem] md:pt-[5.6rem] pb-[3rem] md:pb-[4.2rem] mb-5 md:mb-10 cursor-pointer hover:bg-dark_beige/[0.25] checked:bg-dark_beige transition-bg duration-global ease-out",
                                children: [
                                  (0, r.jsxs)("div", {
                                    className:
                                      "flex flex-col md:flex-row text-light_beige checked:text-white transition-colors duration-global ease-out",
                                    children: [
                                      (0, r.jsxs)("div", {
                                        className:
                                  ...
                                  (0, r.jsx)("div", {
                                    className:
                                      "w-full md:pr-[8rem] md:w-[50%] lg:w-[40%] xl:w-full text-light_beige text-13 leading-[2rem] tracking-[0.013rem] md:text-12 md:leading-[141%] md:tracking-[0.012rem] checked:text-white transition-colors duration-global ease-out",
                                    children: (0, r.jsx)(v, {
                              ...
                              (0, r.jsxs)("label", {
                                ...
                                className:
                                  "relative block bg-light_beige/50 xl:bg-light_beige/30 px-[2.5rem] md:px-30 pt-[3.9rem] md:pt-[5.6rem] pb-[3rem] md:pb-[4.2rem] cursor-pointer hover:bg-dark_beige/[0.25] checked:bg-dark_beige transition-bg duration-global ease-out",
                                children: [
                                  (0, r.jsxs)("div", {
                                    className:
                                      "flex flex-col md:flex-row text-light_beige checked:text-white transition-colors duration-global ease-out",
                              ...
                              (0, r.jsxs)("div", {
                                className:
                                  "flex flex-col md:inline-block px-[0.5rem] md:px-0 mt-20 text-13 leading-[2rem] tracking-[0.013rem] md:text-12 md:leading-[141%] md:tracking-[0.012rem] text-light_beige",
                                children: [
                                  (0, r.jsx)("span", {
                              ...
                              children: [
                                (0, r.jsxs)(g, {
                                  ...
                                  children: [
                                    ...
                                    (0, r.jsxs)("div", {
                                      className:
                                        "flex items-center mt-[5.6rem] body-14 text-light_beige",
                                      children: [
                                        (0, r.jsxs)("div", {
                                          className:
                                          ...
                                          children: [
                                            (0, r.jsx)("input", {
                                              ref: A,
                                              className:
                                                "newsletter-checkbox w-full h-full bg-transparent border-px border-dark_grey/[0.15] appearance-none cursor-pointer",
                                              type: "checkbox",
                                              id: "newsletter",
                                              name: "newsletter",
                                            }),
                                    ...
                                    (0, r.jsx)("div", {
                                      className:
                                        "text-10 leading-[1.5rem] text-light_beige mt-[5.8rem]",
                                      children: (0, r.jsx)(v, {
                      ...
                      (0, r.jsx)("div", {
                        ...
                        children: (0, r.jsxs)("div", {
                          ...
                          children: [
                            (0, r.jsxs)("div", {
                              className:
                                "relative flex justify-between font-headings text-light_beige text-20 leading-[96%] -tracking-[0.02rem] px-[0.6rem] py-[2.4rem] border-b-px border-light_beige",
                              children: [
                                (0, r.jsx)("span", {
