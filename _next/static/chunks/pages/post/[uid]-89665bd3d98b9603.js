			...
			! function (e) {
				...
				var t, r, n = function () {
					...
					o = function (e, t, r) {
						...
						return function (e) {
							var t = e + (.5 - e) * n;
							return e < s ? l ? 1 - (e = 1 - e / s) * e : t - (e = 1 - e / s) * e * e * e * t : e > o ? l ? 1 === e ? 0 : 1 - (e = (e - o) / s) * e : t + (e - t) * (e = (e - o) / s) * e * e * e : l ? 1 : t
						}
					},
					l = function (e, r, n) {
						var a = Math.log(r / e),
					...
					c = function (e) {
						...
						for (var r, n, s, o, l, c, u, d = e.taper || "none", f = [], p = 0, h = 0 | (+e.points || 20), m = h, x = a(e.randomize, !0), g = a(e.clamp), w = t ? t.parseEase(e.template) : 0, v = .4 * (+e.strength || 1); --m > -1;) r = x ? Math.random() : 1 / h * m, n = w ? w(r) : r, s = "none" === d ? v : "out" === d ? (o = 1 - r) * o * v : "in" === d ? r * r * v : r < .5 ? (o = 2 * r) * o * .5 * v : (o = (1 - r) * 2) * o * .5 * v, x ? n += Math.random() * s - .5 * s : m % 2 ? n += .5 * s : n -= .5 * s, g && (n > 1 ? n = 1 : n < 0 && (n = 0)), f[p++] = {
							x: r,
							y: n
						};
						for (f.sort(function (e, t) {
								return e.x - t.x
							}), c = new i(1, 1, null), m = h; m--;) l = f[m], c = new i(l.x, l.y, c);
						return u = new i(0, 0, c.t ? c : c.next),
							function (e) {
								var t = u;
								if (e > t.t) {
		...
		6892: function (e, t, r) {
			...
			t.Z = e => {
				let {
					...
					sticky: r = !1,
					zIndex: i = 0
				} = e, c = (0, a.useRef)(null), u = (0, a.useRef)(null), d = (0, o.o)(e => e.headerLoaded), f = (0, o.o)(e => e.setHeaderDark);
			...
			var n = r(5893),
				...
				h = e => {
					let {
						...
						simple: l = !1,
						children: h
					} = e, m = (0, s.useRef)(), x = (0, s.useRef)(), g = (0, s.useRef)(), w = (0, s.useRef)(), v = (0, s.useRef)(), j = (0, s.useRef)(), C = (0, s.useRef)(), y = (0, s.useRef)(), E = (0, s.useRef)(), _ = (0, s.useRef)(), b = (0, s.useRef)(0), N = (0, p.LZ)(), R = (0, a.o)(e => e.startTransition), L = (0, a.o)(e => e.setIsAppear), S = (0, a.o)(e => e.isLoaded), k = (0, a.o)(e => e.isFirstLoaded), T = (0, a.o)(e => e.setCursorHidden), M = () => {
						y.current && o.p8.set(y.current, {
						...
						let n = window.innerWidth / 83,
							...
							l = o.p8.timeline({
								...
								onComplete: () => {
									window.dispatchEvent(new CustomEvent("is-appeared")), N && N.start(), f.ScrollTrigger.refresh(), e && window.dispatchEvent(new CustomEvent("introduction-complete")), x.current && (x.current.style.clipPath = null), C.current && C.current.classList.add("hidden"), E.current && E.current.classList.add("hidden")
								}
							});
						l.addLabel("start", 0), e && l.fromTo(b, {
							current: 0
						}, {
							current: 100,
							ease: "linear",
							duration: 2.5,
							onUpdate: () => {
								_.current.innerHTML = b.current < 100 ? "0" + Math.round(b.current) : Math.round(b.current)
							}
							...
							ease: "power2.out",
							duration: 2
						}, "start").fromTo(w.current, {
							autoAlpha: 0
						}, {
							autoAlpha: 1,
							ease: "power2.out",
							duration: 1.2
						}, "start"), l.fromTo(y.current, {
							rotate: -90,
							scale: 0
						}, {
							scale: (n > a ? n : a) + 8,
							...
							duration: 2,
							ease: "beaucoup.intro"
						}, e ? "start+=2.7" : "start+=1.5").to([w.current, g.current], {
							autoAlpha: 0,
							ease: "power2.out",
							duration: .4
						}, "<30%").call(() => {
					...
					return (0, s.useEffect)(() => {
						o.p8.registerPlugin(d.SlowMo), o.p8.registerPlugin(i()), i().create("beaucoup.intro", "0.89, 0.12, 0.21, 1.00"), k && E.current && E.current.classList.add("hidden")
					}, []), (0, s.useEffect)(() => {
