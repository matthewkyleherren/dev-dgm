    ...
    578: function (e, t, r) {
      ...
      let m = (e) => {
        ...
        p = (e) => {
          ...
          return (0, l.jsx)("div", {
            className:
              "bg-light_beige bg-opacity-20 h-0 pb-[65.67%] lg:pb-[49.94%] relative",
          ...
          return (0, l.jsxs)("div", {
            ...
            children: [
              t.primary.left_content_title &&
                ...
                (0, l.jsxs)("div", {
                  className:
                    "bg-light_beige bg-opacity-20 flex flex-col gap-[2.4rem] lg:gap-[12.4rem] justify-between px-[2.4rem] py-[2.8rem] lg:p-[4rem] w-full",
                  children: [
                    (0, l.jsx)("div", {
                      className:
