    ...
    [19], {
        2692: function (e, r, t) {
            ...
            r.Z = e => {
                ...
                return (0, n.jsx)("div", {
                    className: "p-[1.8rem] lg:p-40\n  ".concat(a ? "backdrop-blur-[105px] text-white" : "bg-white text-light_beige", "\n  ").concat("small" === t && a ? "w-[26.4rem] lg:w-[31rem]" : "", "\n  ").concat("small" !== t || a ? "" : "w-full md:w-[26.4rem] lg:w-[31rem]", "\n  ").concat("small" !== t && a ? "w-[26.4rem] lg:w-[36.8rem]" : "", "\n  ").concat("small" === t || a ? "" : "w-full md:w-[26.4rem] lg:w-[36.8rem]", "\n  "),
                    children: r
                })
            }
        },
            ...
            var n = t(5893),
                ...
                p = e => {
                    let {
                        ...
                        simple: s = !1,
                        children: p
                    } = e, m = (0, l.useRef)(), g = (0, l.useRef)(), w = (0, l.useRef)(), x = (0, l.useRef)(), v = (0, l.useRef)(), y = (0, l.useRef)(), j = (0, l.useRef)(), b = (0, l.useRef)(), k = (0, l.useRef)(), C = (0, l.useRef)(), R = (0, l.useRef)(0), _ = (0, h.LZ)(), N = (0, a.o)(e => e.startTransition), A = (0, a.o)(e => e.setIsAppear), P = (0, a.o)(e => e.isLoaded), E = (0, a.o)(e => e.isFirstLoaded), L = (0, a.o)(e => e.setCursorHidden), S = () => {
                        ...
                        let t = i.p8.timeline({
                            ...
                            onComplete: () => {
                                window.dispatchEvent(new CustomEvent("is-appeared")), _ && _.start(), f.ScrollTrigger.refresh()
                            }
                        });
                        t.fromTo(r, {
                            autoAlpha: 1
                        ...
                        let n = window.innerWidth / 83,
                            ...
                            s = i.p8.timeline({
                                ...
                                onComplete: () => {
                                    window.dispatchEvent(new CustomEvent("is-appeared")), _ && _.start(), f.ScrollTrigger.refresh(), e && window.dispatchEvent(new CustomEvent("introduction-complete")), g.current && (g.current.style.clipPath = null), j.current && j.current.classList.add("hidden"), k.current && k.current.classList.add("hidden")
                                }
                            });
                        s.addLabel("start", 0), e && s.fromTo(R, {
                            current: 0
                        }, {
                            current: 100,
                            ease: "linear",
                    ...
                    return (0, l.useEffect)(() => {
                        i.p8.registerPlugin(d.SlowMo), i.p8.registerPlugin(o()), o().create("beaucoup.intro", "0.89, 0.12, 0.21, 1.00"), E && k.current && k.current.classList.add("hidden")
                    }, []), (0, l.useEffect)(() => {
        ...
        1019: function (e, r, t) {
            ...
            r.default = e => {
                let {
                    ...
                    slices: t,
                    index: m
                } = e, g = (0, l.useRef)(null), w = (0, l.useRef)(null), x = (0, l.useRef)(null), v = (0, l.useRef)([]), y = (0, l.useRef)([]), j = (0, l.useRef)([]), b = (0, l.useRef)([]), k = (0, l.useRef)(null), C = (0, l.useRef)(null), R = (0, l.useRef)(null), _ = (0, l.useRef)(null), N = (0, l.useRef)(null), A = (0, l.useRef)(null), P = (0, l.useRef)(null), E = (0, l.useRef)(null), L = (0, l.useRef)(null), S = (0, h.o)(e => e.setCursorHidden), T = (0, h.o)(e => e.isAppear), [Z, z] = (0, l.useState)(0), H = (0, c.a)("(max-width: 1024px)", !0), W = (0, l.useRef)(null), B = (0, l.useRef)(null), O = (0, l.useRef)(null), M = (0, l.useRef)(null), D = (0, l.useRef)(null), F = (0, l.useRef)(null), U = (0, l.useRef)(null), q = (0, l.useRef)(null), V = (0, l.useRef)(null), I = () => {
                    let e = i.p8.timeline();
                    e.to(w.current, {
                    ...
                    return window.innerWidth < 1024 && (t = window.innerWidth / 15), r.fromTo(R.current, {
                        y: 0
                    }, {
                    ...
                    window.innerWidth < 1024 && (e = "default" === r.variation ? "-0.368rem" : "-0.252rem"), "default" !== r.variation && (q.current = i.p8.timeline({
                        paused: !0,
                        defaults: {
                            duration: 1.2,
                            ease: "power4.inOut"
                    ...
                    }), window.innerWidth < 768 ? (q.current.to(y.current, {
                        autoAlpha: 0,
                        duration: .5,
                        ease: "power2.out"
                    }, 0).to(b.current, {
                    ...
                    _.current = "-2.5rem", i.p8.set([P.current, E.current], {
                        scale: 1.2
                    }), window.innerWidth < 1024 && (_.current = "-1.3rem"), window.innerWidth >= 768 ? (C.current && i.p8.set(C.current, {
                        autoAlpha: 0
                    }), k.current && i.p8.set(k.current, {
                        yPercent: 140
                    }), j.current.length > 0 && i.p8.set(j.current, {
                        yPercent: 100
                    }), y.current[0] && i.p8.set(y.current[0], {
                        yPercent: 100
                    }), v.current && i.p8.set(v.current, {
                        yPercent: 100,
                        letterSpacing: _.current
                    }), b.current[0] && i.p8.set(b.current[0], {
                        yPercent: 100
                    }), j.current.length > 0 && i.p8.set(j.current, {
                        yPercent: 100,
                        letterSpacing: _.current
                    })) : b.current.length > 0 && i.p8.set(b.current, {
                        autoAlpha: 0
                    })
                }, J = () => {
                    A.current = "default" === r.variation ? window.innerHeight : .75 * window.innerHeight
                }, Q = () => {
                    let e = i.p8.timeline(),
                        t = "default" === r.variation ? "-0.96rem" : "-0.66rem";
                    window.innerWidth < 1024 && (t = "default" === r.variation ? "-0.368rem" : "-0.252rem"), e.fromTo([P.current, E.current], {
                        scale: 1.2
                    }, {
                        scale: 1,
                        ease: "expo.out",
                        duration: 1.6
                    }, .3), "default" === r.variation ? (e.to(v.current, {
                        yPercent: 0,
                        letterSpacing: t,
                        duration: 1.8,
                        ease: "power4.inOut"
                    ...
                    L.current = !0, N.current && N.current.ref && i.p8.set(N.current.ref, {
                        autoAlpha: 1
                    }), k.current && k.current.classList.remove("hidden"), z(1)
                };
                return (0, l.useEffect)(() => {
                    T && Q()
                }, [T]), (0, l.useEffect)(() => {
                    K(), G(), N.current && N.current.ref && i.p8.set(N.current.ref, {
                        autoAlpha: 0
                    });
                    let {
                        scaleAnimation: e,
                    ...
                    if (W.current = s.ScrollTrigger.create({
                            trigger: g.current,
                            start: "bottom bottom",
                            end: () => "+=".concat(.5 * w.current.clientHeight),
                            animation: e,
                            scrub: !0
                            ...
                            scrub: !0,
                            onLeaveBack: () => {
                                k.current && ((0, o.RE)(U.current), F.current = i.p8.to(k.current, {
                                    yPercent: 0,
                                    ease: "power2.inOut",
                                    duration: .9
                                }))
                            }
                        }), "default" !== r.variation && (M.current = s.ScrollTrigger.create({
                            trigger: g.current,
                            start: "top top-=10px",
                            onEnter: () => {
                        ...
                        C.current && e.to(C.current, {
                            autoAlpha: 0,
                            ease: "linear",
                            duration: .3
                        }, 0), k.current && e.fromTo(k.current, {
                            yPercent: 140
                        }, {
                            yPercent: 0,
                            ease: "power2.inOut",
                            duration: .9
                        }, 0), O.current = s.ScrollTrigger.create({
                            trigger: g.current,
                            start: "top top-=25%",
                            onEnter: () => {
                                e.play()
                    ...
                    return window.addEventListener("resize", J), window.addEventListener("is-appeared", X), () => {
                        window.removeEventListener("resize", J), window.removeEventListener("is-appeared", X), W.current.kill(), W.current = null, B.current.kill(), B.current = null, M.current && M.current.kill(), M.current && (M.current = null), O.current && O.current.kill(), O.current && (O.current = null)
                    }
                }, []), (0, l.useEffect)(() => (A.current = "default" === r.variation ? window.innerHeight : .75 * window.innerHeight, H || (D.current = s.ScrollTrigger.create({
                    trigger: g.current,
                    start: "bottom bottom",
                    ...
                    children: (0, n.jsx)("section", {
                        ...
                        className: "relative ".concat("White" === r.primary.background_color ? "bg-white" : "Beige light" === r.primary.background_color ? "bg-light_beige" : "Beige dark" === r.primary.background_color ? "bg-dark_beige" : "Grey dark" === r.primary.background_color ? "bg-dark_grey" : "bg-green"),
                        ref: g,
                        onMouseEnter: () => {
                            L.current && z(1), S(!0)
                        },
                        ...
                        children: (0, n.jsx)("div", {
                            className: "relative ".concat("default" === r.variation ? "h-[200vh]" : "h-[175vh]", " text-white"),
                            children: (0, n.jsx)("div", {
                                ...
                                children: (0, n.jsxs)("div", {
                                    ...
                                    children: [!H && (0, n.jsx)("div", {
                                        ...
                                        children: [(0, n.jsx)("div", {
                                            ...
                                            children: "default" === r.variation ? (0, n.jsx)("div", {
                                                ref: v,
                                                ...
                                                children: [(0, n.jsx)("div", {
                                                    className: "relative",
                                                    children: r.primary.title.map((e, r) => (0, n.jsx)("div", {
                                                        ref: e => y.current[r] = e,
                                                        children: (0, n.jsx)("div", {
                                                            ref: e => v.current[r] = e,
                                                            children: e.text
                                                    ...
                                                    children: r.primary.second_title.map((e, r) => (0, n.jsx)("div", {
                                                        ref: e => b.current[r] = e,
                                                        children: (0, n.jsx)("div", {
                                                            ref: e => j.current[r] = e,
                                                            children: e.text
                                        ...
                                        }), "default" === r.variation && r.primary.bottom_title && (0, n.jsx)("div", {
                                            ref: C,
                                        ...
                                        }), "default" === r.variation && r.primary.right_content && (0, n.jsx)("div", {
                                            ref: k,
                                            className: "absolute hidden bottom-10 right-10 md:bottom-20 md:right-20 bg-dark_grey/50 z-3 text-20 leading-[105%] -tracking-[0.06rem]",
                                            children: (0, n.jsxs)(d.Z, {
                                                size: "large",
                                                children: [r.primary.right_title && (0, n.jsx)("div", {
